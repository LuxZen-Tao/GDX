...
Main project is in `gdx-template/`.

- Setup and run steps: `gdx-template/README.md`
...
Run the game and click "Enhanced UI Demo" to see a working example of:
- Multi-panel layouts with Tables
- UI connected to simulation data
- Interactive buttons that modify game state
- Color-coded statistics
- Dialog windows

Study `EnhancedGameScreen.java` as a reference for building your own UI screens!
